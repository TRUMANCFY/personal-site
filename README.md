...
2. Add an image of yourself in `public/images/person.jpg`. If you decide to change the filename, be sure to go back to the sidebar and change the image path there as well.
